...
async function seedData() {
  ...
  try {
    ...
    const existingPlan = await client.query("SELECT id FROM anc_plan_versions WHERE status = $1", [
      "ACTIVE",
    ]);
      ...
      const milestones = [
        {
          ...
          e: 12,
          cat: "ANC",
          pol: "PUSKESMAS_REQUIRED",
          fac: JSON.stringify(["PUSKESMAS"]),
        },
        {
          code: "K2",
          tri: "Trimester 2",
          ...
          cat: "ANC",
          pol: "FLEXIBLE",
          fac: JSON.stringify(["POSYANDU", "PUSKESMAS", "MIDWIFE_PRACTICE"]),
        },
        {
          code: "K3",
          tri: "Trimester 2",
        ...
        },
        {
          ...
          e: 42,
          cat: "DELIVERY",
          pol: "PONED_OR_RS_REQUIRED",
          fac: JSON.stringify(["PONED", "HOSPITAL"]),
        },
      ];
