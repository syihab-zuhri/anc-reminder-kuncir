...
const TAB_DEFINITIONS: readonly TabDefinition[] = [
  ...
  },
  {
    ...
    shortLabel: "Siar",
    allowedRoles: ["PUSKESMAS"],
    description: "Kirim pengumuman siaran sebagai notifikasi push ke ibu hamil.",
  },
  {
    id: "admin",
    label: "Administrasi",
    ...
    <div className="staff-workspace">
      ...
      <aside className="staff-rail">
        <div className="staff-rail-topbar">
          ...
          <button
            className="staff-rail-logout staff-rail-logout-mobile"
            type="button"
            onClick={logout}
            disabled={loggingOut}
          >
        ...
        <button
          className="staff-rail-logout staff-rail-logout-desktop"
          type="button"
          onClick={logout}
          disabled={loggingOut}
        >
      ...
      <main className="staff-workspace-main">
        ...
        {effectiveTab === "announcements" && staff.role === "PUSKESMAS" && (
          <AnnouncementPanel userRole={staff.role} />
        )}
